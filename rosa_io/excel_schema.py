...
EXCEL_HEADERS = [
    ...
    "Knees at 90 deg",
    "Too Low - Knee Angle < 90 deg",
    "Too High - Knee Angle > 90 deg",
    ...
    "Adequate lumbar support - chair reclined between 95-110 deg",
    "No lumbar support or lumbar support not positioned in small of back",
    "Angled too far back (>110 deg) or too far forward (<95 deg)",
    "No back support (e.g., stool or worker leaning forward)",
    "Hard / damaged surface",
    "Armrests too wide",
    "Neck twist greater than 30 deg",
...
_QUERY_HEADER_MAP: Dict[str, Tuple[str, str]] = {
    ...
    "Work Surface too High": ("front", "work_surface_too_high"),
    ...
    "Mouse in line with shoulder": ("front", "mouse_in_line_with_shoulder"),
    "Reaching to mouse": ("front", "reaching_to_mouse"),
    "Mouse/Keyboard on different surfaces": ("front", "mouse_keyboard_on_different_surfaces"),
    "Pinch grip on mouse": ("front", "pinch_grip_on_mouse"),
    "Keyboard too high - shoulders shrugged": ("front", "keyboard_too_high_shoulders_shrugged"),
    "Knees at 90 deg": ("side", "knees_at_90_deg"),
    "Too Low - Knee Angle < 90 deg": ("side", "too_low_knee_angle_less_than_90_deg"),
    "Too High - Knee Angle > 90 deg": ("side", "too_high_knee_angle_greater_than_90_deg"),
    ...
    "Adequate lumbar support - chair reclined between 95-110 deg": ("side", "adequate_lumbar_support_chair_reclined_between_95_110_deg"),
    ...
    "Angled too far back (>110 deg) or too far forward (<95 deg)": ("side", "angled_too_far_back_greater_than_110_or_too_far_forward_less_than_95"),
    ...
    "Armrests too wide": ("side", "armrests_too_wide"),
    "Neck twist greater than 30 deg": ("overhead", "neck_twist_greater_than_30_deg"),
...
def build_excel_row(
    ...
    for header, (section_key, query_key) in _QUERY_HEADER_MAP.items():
        raw = sources.get(section_key, {}).get(query_key, 0)
        row[header] = int(raw) if raw else ""
